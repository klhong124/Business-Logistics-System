...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2019 at 07:32 PM
...
--
CREATE DATABASE IF NOT EXISTS `cc_logistics` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cc_logistics`;
...
(60, '2019-03-03 18:09:30', NULL, NULL, NULL, '2019-03-03 18:09:30'),
(69, '2019-03-03 18:20:12', NULL, NULL, NULL, '2019-03-03 18:20:12'),
(73, '2019-03-03 18:30:45', NULL, NULL, NULL, '2019-03-03 18:30:45'),
(74, '2019-03-03 18:31:14', NULL, NULL, NULL, '2019-03-03 18:31:14');
...
INSERT INTO `invoice_receiver` (`invoice_id`, `name`, `address`, `contact`) VALUES
...
INSERT INTO `shipper_table` (`shipper_id`, `username`, `email`, `password`, `update_at`, `create_at`, `remember_token`) VALUES
(9, 'cyokhe Ltd.', 'abc@www', 'password', '2019-03-03 18:09:30', '2019-03-04 02:09:30', NULL),
(13, 'KENNY LTD', 'KB@www', 'password', '2019-03-03 18:30:45', '2019-03-04 02:30:45', NULL);
...
--
-- Indexes for table `shipper_table`
--
ALTER TABLE `shipper_table`
...
--
-- AUTO_INCREMENT for table `shipper_table`
--
ALTER TABLE `shipper_table`
  MODIFY `shipper_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `invoice_table`
  ADD CONSTRAINT `invoice_table_ibfk_1` FOREIGN KEY (`shipper_id`) REFERENCES `shipper_table` (`shipper_id`);
--
...
-- Database: `hererice`
--
CREATE DATABASE IF NOT EXISTS `hererice` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hererice`;
...
INSERT INTO `login_system` (`user_id`, `user_name`, `phone`, `email`, `password`, `owner`) VALUES
(19, 'cafe de coral', 12334123, 'coral@gmail.com', 'admin', 1);
...
INSERT INTO `menu_item` (`menu_id`, `item_name`, `item_price`, `item_id`) VALUES
(7, 'Scrambled Egg w/ Mil', 30, 16),
(7, 'Hoki Fillet ', 26, 17),
(7, 'Sesame Bun w/ Butter', 38, 18),
(7, 'Pork Chop Cutlet ', 27, 19),
(8, 'Daily Value', 36, 20),
(8, 'Chef\'s Secret Kitche', 48, 22),
(8, 'Slow-cooked Beef Bri', 56, 23),
(8, 'Vegetable Rice Serie', 42, 24),
(10, 'w', 8, 25),
(10, 'Tea', 6, 26),
(10, 'Coffee', 13, 27),
(10, 'Soft Drink', 9, 28),
(10, 'Iced Green Tea', 8, 29),
(13, 'Grilled Pork Chop Cr', 27, 30),
(13, 'Chicken Wing', 23, 31),
(13, 'Roasted Chicken w/ L', 24, 32),
(14, 'Slow-cooked Beef Bri', 56, 33),
(14, 'Vegetable Rice Serie', 47, 34),
(14, 'Late Supper', 45, 35),
(14, 'Local Delicacies', 50, 36),
(15, 'wref', 23, 37);
...
INSERT INTO `shop_info` (`user_id`, `shop_id`, `opening_time`, `closing_time`, `shop_name`, `shop_address`, `shop_phone`) VALUES
(19, 7, '04:00:00', '22:00:00', 'cafe de coral', ' Shop A-B, Honland Building, 109-118 Prince Edward Road, Prince Edward', 27553850);
...
INSERT INTO `shop_menu` (`shop_id`, `menu_id`, `menu_name`, `set_or_not`) VALUES
(7, 7, 'Breakfast', 6),
(7, 8, 'Lunch', 1),
(7, 10, 'Drink Menu', 0),
(7, 13, 'Tea', 10),
...
INSERT INTO `user_info` (`user_id`, `surname`, `first_name`, `gender`, `birthday`) VALUES
(19, 'de coral', 'cafe', 'male', '1968-02-07');
...
--
ALTER TABLE `login_system`
  MODIFY `user_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `menu_item`
--
ALTER TABLE `menu_item`
  MODIFY `item_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `shop_info`
  MODIFY `shop_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `shop_menu`
--
ALTER TABLE `shop_menu`
  MODIFY `menu_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `menu_item`
  ADD CONSTRAINT `menu_item_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `shop_menu` (`menu_id`);

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `login_system` (`user_id`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `menu_item` (`item_id`);

--
-- Constraints for table `shop_info`
--
ALTER TABLE `shop_info`
  ADD CONSTRAINT `shop_info_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `login_system` (`user_id`);

--
-- Constraints for table `shop_menu`
--
ALTER TABLE `shop_menu`
  ADD CONSTRAINT `shop_menu_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop_info` (`shop_id`);

--
-- Constraints for table `user_info`
--
ALTER TABLE `user_info`
  ADD CONSTRAINT `user_info_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `login_system` (`user_id`);
--
-- Database: `my220db`
--
CREATE DATABASE IF NOT EXISTS `my220db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `my220db`;
...
INSERT INTO `accountdetail` (`Acc_No`, `Customer`, `Address`) VALUES
(32, 'Tasty Bite', '17 Wood Place, Insch'),
(167, 'Sally\'s Snacks', '3 High Street, Banchory'),
(178, 'Daisy\'s Cafe', '27 Bay Drive, Cove'),
(526, 'Smiths', '12 Dee View, Aberdeen');
...
INSERT INTO `itemdetail` (`Item_No`, `Item`, `Item_Price`) VALUES
(1, 'Bakewell Tart', 0.15),
(2, 'Danish Pastry', 0.2),
(3, 'Apple Pie', 0.15),
(4, 'Butteries', 0.2),
(5, 'Cherry Pie', 0.18),
...
INSERT INTO `order` (`Order_No`, `Acc_No`, `Date`) VALUES
(1234, 178, '2018-11-04'),
(1788, 32, '2018-07-18'),
(2276, 167, '2018-07-17'),
(2828, 526, '2018-11-06'),
...
INSERT INTO `orderdetail` (`Order_No`, `Item_No`, `Qty`) VALUES
(7823, 1, 20),
(7823, 2, 13),
(7823, 3, 45),
(4633, 4, 120),
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`Acc_No`) REFERENCES `accountdetail` (`Acc_No`);

--
-- Constraints for table `orderdetail`
--
ALTER TABLE `orderdetail`
  ADD CONSTRAINT `orderdetail_ibfk_2` FOREIGN KEY (`Order_No`) REFERENCES `order` (`Order_No`),
  ADD CONSTRAINT `orderdetail_ibfk_3` FOREIGN KEY (`Item_No`) REFERENCES `itemdetail` (`Item_No`);
--
-- Database: `phpmyadmin`
--
...
('ryananadb', 'ProductID', 'int', '10', '', 0, ',', ''),
('ryananadb', 'User_ID', 'int', '10', '', 0, ',', '');
...
('root', '[{\"db\":\"cc_logistics\",\"table\":\"shipper_table\"},{\"db\":\"cc_logistics\",\"table\":\"invoice_table\"},{\"db\":\"cc_logistics\",\"table\":\"invoice_receiver\"},{\"db\":\"cc_logistics\",\"table\":\"invoice_process\"},{\"db\":\"cc_logistics\",\"table\":\"invoice_detail\"},{\"db\":\"cc_logistics\",\"table\":\"shipper_tabsle\"},{\"db\":\"cc_logistics\",\"table\":\"test\"},{\"db\":\"cc_logistics\",\"table\":\"users\"},{\"db\":\"cc_logistics\",\"table\":\"order_request\"},{\"db\":\"my220db\",\"table\":\"orderdetail\"}]');
...
('root', 'cc_logistics', 'invoice_table', '{\"sorted_col\":\"`invoice_id` ASC\"}', '2019-03-03 18:08:58'),
('root', 'ryananadb', 'loginsystem', '{\"sorted_col\":\"`loginsystem`.`E-mail` ASC\"}', '2018-03-19 11:08:47');
...
('my220', '2018-11-20 11:47:23', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}'),
('root', '2019-02-19 16:24:57', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}'),
('ryanana', '2018-03-18 15:10:36', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- Database: `ryananadb`
--
CREATE DATABASE IF NOT EXISTS `ryananadb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ryananadb`;
...
INSERT INTO `bill` (`Bill_No`, `User_ID`, `ProductID`) VALUES
(34, 59, 6),
(34, 59, 5),
(34, 59, 1),
(35, 59, 7),
...
--
-- Table structure for table `billsystem`
--

CREATE TABLE `billsystem` (
  `Bill_ID` int(10) NOT NULL,
  `User_ID` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `billsystem`
--

INSERT INTO `billsystem` (`Bill_ID`, `User_ID`) VALUES
(34, 59),
(35, 59),
(43, 59),
(45, 59),
...
INSERT INTO `cart` (`cart_ID`, `User_ID`, `ProductID`) VALUES
(1, 59, 1);
...
CREATE TABLE `feedback` (
  ...
  `Phone` int(8) NOT NULL,
  `Email_Reply` varchar(3) NOT NULL,
  `Call_Reply` varchar(3) NOT NULL,
  `SMS_Reply` varchar(3) NOT NULL,
...
INSERT INTO `feedback` (`Name`, `Content`, `Email`, `Phone`, `Email_Reply`, `Call_Reply`, `SMS_Reply`, `Feedback_ID`) VALUES
('demo', 'I Like The website', '22234567', 0, 'Yes', 'No', 'No', 70),
('demo msg', '1234', 'klhnog', 123, 'Yes', 'No', 'No', 74),
('demo', 'hi', '22234567', 0, 'No', 'No', 'No', 75);
...
INSERT INTO `loginsystem` (`User_ID`, `Username`, `Password`, `E-mail`, `PhoneNo`) VALUES
(47, 'admin', 'admin', 'admin@gmail.com', 21809876),
(59, 'demo', 'demo', 'demo@gmail.com', 22234567),
(61, 'demo2', 'demo', 'qwqwf', 12345676),
(62, 'demo1', 'demo', 'demodeomo', 32423412),
(63, 'lulu', 'lulu', 'lulu', 12318233),
(64, 'testing', 'testing', 'testing@gmail.com', 23456789),
(65, 'demo123', 'demo123', 'demo@gmail.com', 12345645),
(66, 'demo1234', '123', 'wqe', 12312312),
(67, 'yolanda', 'Ab25560531', 'yoLANDA CHAR@GMAL.COM', 79768474);
...
INSERT INTO `market` (`ProductID`, `Productname`, `Productprice`) VALUES
(1, 'Batman', 50),
(2, 'Redcode', 47),
(3, 'Crysyal', 56),
(4, 'Kiss', 64),
...
--
-- Indexes for table `billsystem`
--
ALTER TABLE `billsystem`
  ADD PRIMARY KEY (`Bill_ID`),
  ADD KEY `billsystem_ibfk_1` (`User_ID`);
...
--
-- AUTO_INCREMENT for table `billsystem`
--
ALTER TABLE `billsystem`
  MODIFY `Bill_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `bill`
  ADD CONSTRAINT `bill_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `loginsystem` (`User_ID`),
  ADD CONSTRAINT `bill_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `market` (`ProductID`),
  ADD CONSTRAINT `bill_ibfk_3` FOREIGN KEY (`Bill_No`) REFERENCES `billsystem` (`Bill_ID`);

--
-- Constraints for table `billsystem`
--
ALTER TABLE `billsystem`
  ADD CONSTRAINT `billsystem_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `loginsystem` (`User_ID`);

--
-- Constraints for table `cart`
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`ProductID`) REFERENCES `market` (`ProductID`),
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`User_ID`) REFERENCES `loginsystem` (`User_ID`);
--
-- Database: `test`
--
...
-- Database: `wk2ex2`
--
CREATE DATABASE IF NOT EXISTS `wk2ex2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `wk2ex2`;
...
CREATE TABLE `item` (
  ...
  `item price` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
